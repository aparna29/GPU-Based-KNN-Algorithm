...
double KNN(double feature_arr[][120],int num_features,int ndim,int train,int query,int k)
{
...
int main()
{
	...
	{
	start = clock();
    double ans = KNN(feature_arr,num_features,ndim,train,query,k);
    end = clock();
    //printf("\nLabel = %lf",ans);
    printf("\n %d\t%lf",ndim,((double) (end - start))*1000.0 / CLOCKS_PER_SEC);
	}
